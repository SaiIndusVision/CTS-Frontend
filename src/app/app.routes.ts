...
//   { path: 'dashboard', canActivate: [authGuard], component: DashboardComponent }, // will redirect in guard
...
import { UserSlotsComponent } from './slots/user-slots/user-slots';
import { LandingComponent } from './landing/landing';
// import { PageNotFoundComponent } from './page-not-found/page-not-found'; // optional 404 component
...
//   // Optional: 404 page
  ...
  // Wildcard route for 404 page
   // optional, replace with dashboard if needed
];
